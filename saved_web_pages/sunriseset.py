# Based on: http://michelanders.blogspot.com.au/2010/12/calulating-sunrise-and-sunset-in-python.html
...
sunriseFudgeMinutes = 0
sunsetFudgeMinutes = 0
...
class sun:
 ...
 """
 The two fudge factors are in minutes. Use negative to move the fudge earlier. 
 """
...
if __name__ == "__main__":
 ...
 print('morning night -> day transition at: ' + str(sun.timefromdecimalday(s.sunrise_t+(sunriseFudgeMinutes/60.0/24.0))))
 print('evening day -> night transition at: ' + str(sun.timefromdecimalday(s.sunset_t+(sunriseFudgeMinutes/60.0/24.0))))
