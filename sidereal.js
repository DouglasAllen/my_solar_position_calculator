...
{	DefaultLongitude = -88.743;	// Put YOUR default local longitude here...
...
document.clock.gmstangle.value = " " + getGMST(now); //addZero(gmstdeg) + "° " + addZero(gmstmin) + "\' " + addZero(gmstsec) + "\"";
document.clock.angle.value = " " + (second / 3600 + minute / 60 + hour) * 15; //addZero(deg) + "° " + addZero(min) + "\' " + addZero(sec) + "\"";
...
var GMST = 280.46061837 + jd * 360.98564736629 + jc * jc * (0.000387933 + jc * -1 / 38710000);
